...
class OccasionProductGrid extends StatefulWidget {
  ...
  @override
  State<OccasionProductGrid> createState() => _OccasionProductGridState();
}

class _OccasionProductGridState extends State<OccasionProductGrid> {
  ...
  Widget _buildProductGrid(List<OccasionProduct> products, BuildContext context) {
    if (products.isEmpty) {
      return Container(
        height: 200,
        child: Center(
